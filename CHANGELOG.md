...
Todos los cambios relevantes de Cartagenaeste. Formato basado en [Keep a Changelog](https://keepachangelog.com/es-ES/1.1.0/) y [SemVer](https://semver.org/spec/v2.0.0.html).
...
- **CSP**: IP interna `http://REDACTED_INTERNAL_IP:3100` eliminada de `connect-src`.
...
- Referencias a la IP `REDACTED_INTERNAL_IP` en 9 archivos (quedan comentarios en docs).
...
## [0.x] — histórico resumido

### 2026-04 (antes del hito 1.0)
- Modularización `index.html` → `app-main.js` + `app-modules.js` + módulos lazy-loaded.
- Registro formal de propiedad intelectual en el Registro de la Región de Murcia (Reg. 00765-03096622, Art. 51 LPI).
- Despliegue en uso clínico en Urgencias H.G.U. Santa Lucía.

### 2026-03
- Fármacos de Urgencia (51 fármacos, dosis, diluciones).
- Buscador vacunas por edad.
- Generador turnos guardia PDF.

### 2026-02
- Triaje QR con ficha 24h.
- 17 especialidades + 136 preguntas estilo MIR.
- Integración GA4 con 7 eventos clínicos custom.

### 2026-01 y anteriores
- Primer prototipo con notebook de docencia clínica.
- Integración básica con Firebase Auth + Firestore.
- Módulos: Calculadoras, Mapa sanitario, Enfermería.

[Unreleased]: https://github.com/carlosgalera-a11y/Cartagenaeste/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/carlosgalera-a11y/Cartagenaeste/releases/tag/v1.0.0
