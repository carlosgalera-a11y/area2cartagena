...
var VISION_CONFIG={
    ...
    openrouterModels:["qwen/qwen3.5-9b","google/gemma-3-27b-it:free","mistralai/mistral-small-3.1-24b-instruct:free"],
...
async function scanAnalyze(){
    ...
    if(!txt){
        try{
            var orKey=_dk();
                var orModels=VISION_CONFIG.openrouterModels||["qwen/qwen3.5-9b","google/gemma-3-27b-it:free","mistralai/mistral-small-3.1-24b-instruct:free"];
